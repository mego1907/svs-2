...
const SingleNewSection = () => {
  return (
    <div className="bg-header-gradient w-full min-h-screen lg:mt-0 mt-5">
      <div className="lg:px-32 px-3">
        <div className="flex lg:flex-row flex-col lg:gap-0 gap-5">
          <div className="flex items-start relative">
            <div className="px-6 bg-black rounded-full absolute lg:-right-10 z-10 -top-4 lg:text-7xl text-3xl font-bold">
              <span>
          ...
          <div className="flex items-center lg:w-96 rounded-md justify-center p-2 bg-[#FFBD59]">
            <div className="flex flex-col gap-3">
              <div className="lg:w-96 relative h-52">
                <img
                  src="/assets/imgs/Group 34 (1).png"
                  alt=""
              ...
              <div className="lg:w-96 relative h-52 rounded-2xl">
                <img
                  src="/assets/imgs/Group 34 (1).png"
                  alt=""
                  className="w-full h-full object-cover rounded-3xl"
              ...
              <div className="lg:w-96 relative h-52 rounded-3xl">
                <img
                  src="/assets/imgs/Group 34 (1).png"
                  alt=""
                  className="w-full h-full object-cover rounded-3xl"

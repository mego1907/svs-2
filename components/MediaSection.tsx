      ...
      <div className="md:px-32 px-3">
        <div className="flex md:flex-row flex-col">
          <div className="flex items-center relative">
            <div className="px-6 bg-black rounded-full absolute md:-left-6 md:top-20 top-5 md:text-7xl text-3xl font-bold">
              <span>
                M<span className="text-[#FFBD59]">EDIA</span>
              </span>
            </div>
            <div className="w-full bg-[#FFBD59] p-5 md:rounded-l-2xl rounded-2xl">
          ...
          <div className="flex items-center md:w-96 rounded-md justify-center p-2 bg-[#FFBD59] md:mt-0 mt-5">
            <div className="flex flex-col gap-3 px-3">
              <div className="md:w-96 w-full relative h-52">
                <img
                  src="/assets/imgs/Group 34 (1).png"
                  alt=""
              ...
              <div className="md:w-96 w-full relative h-52 rounded-2xl">
                <img
                  src="/assets/imgs/Group 34 (1).png"
                  alt=""
                  className="w-full h-full object-cover rounded-3xl"
              ...
              <div className="md:w-96 w-full relative h-52 rounded-3xl">
                <img
                  src="/assets/imgs/Group 34 (1).png"
                  alt=""
                  className="w-full h-full object-cover rounded-3xl"
